...
% the columns are ["id", "condition", "trial", "y"]
M = csvread('/Users/ghislaindentremont/Documents/Experiments/Trajectory/Trajectory Studies/FDA/fake15_mat_long_trim.csv', 1, 1);
% add columms for x and z by copying y
M = [M M(:,3) M(:,3)];
...
group_2 = [];
i=0;
ids = 33;  % for real data, the levels go to 33 even though some participants were dropped
trials = 100;
for id=1:ids
    for condition=1:2
        for trial=1:trials
...
% cd '/Users/ghislaindentremont/Documents/Experiments/Trajectory/Trajectory Studies/MSc_results/fake_fanovan_norm_time_200'
% cd '/Users/ghislaindentremont/Documents/Experiments/Trajectory/Trajectory Studies/MSc_results/fake_fanovan_norm_time_16'
cd '/Users/ghislaindentremont/Documents/Experiments/Trajectory/Trajectory Studies/MSc_results/fake_fanovan_norm_time_15'
